...
class MoodSongsScreen extends ConsumerStatefulWidget {
  final String moodId;
  final String moodName;

  const MoodSongsScreen({super.key, required this.moodId, required this.moodName});

  @override
  ConsumerState<MoodSongsScreen> createState() => _MoodSongsScreenState();
}

class _MoodSongsScreenState extends ConsumerState<MoodSongsScreen> {
  List<Song> _songs = [];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: _isLoading
          ...
          : _songs.isEmpty
              ? const Center(
                  child: Text('No songs for this mood', style: TextStyle(color: AppColors.textTertiary)),
                )
              : ListView.builder(
